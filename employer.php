...
<body background="image/im02.jpg">
    <?php
        ...
        if(isset($_POST['submit'])){
            ...
            $sql = "INSERT INTO `employer` (`ID`,`member_code`, `User_Name`, `User_Email`, `Property`, `Facebook`, `PhoneNumber`,`name_job`, `Price`,`Status`, `Photo_Name`) 
            VALUES (NULL, '".$_SESSION['ID']."','". $_POST['firstname'].' '.$_POST['lastname']."', '".$_POST['email']."', '".$_POST['Property']."', '".$_POST['facebook']."', '".$_POST['phonenumber']."','".$_POST['inputJob']."','".$_POST['price']."','1', '".$newName."');";
                ...
                <div class="card">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="lastname" class="col-sm-3 col-form-label">ยืนยัน Email ของคุณ</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                <label for="phonenumber" class="col-sm-3 col-form-label">บอกเบอร์มาสิ</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <select id="inputJob" class="form-control" name="inputJob" required>
                            ...
                            <div class="form-group row">
                                <label for="price" class="col-sm-3 col-form-label">ค่าแรงขั้นต่ำ</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                <label for="Property" class="col-sm-3 col-form-label">อยากได้แบบไหนก็บอกมาสิ</label>
                                <div class="col-sm-9">
                                    <textarea cols="10" row="5" class="form-control" id="Property" name="Property" required></textarea>
                                </div>
                            </div> 
                        
                        
                            <div class="form-group row">
                                <label for="uploadfile" class="col-sm-3 col-form-label">อัพรูปด้วยนะเดี๋ยวไม่รู้ว่าเป็นใคร</label>
                                <div class="col-sm-9">
