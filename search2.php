        ...
        <div class="row">
            <div class="col-md-13 mx-auto mt-5"> 
                <div class="card">
                    ...
                    $query = "SELECT * FROM worker WHERE Status='1' AND (User_Name LIKE '%".$_GET["txtKeyword2"]."%' 
                    or User_Email LIKE '%".$_GET["txtKeyword2"]."%' 
                    or name_job LIKE '%".$_GET["txtKeyword2"]."%' )"
                    ...
                    //แก้ไขข้อมูล
                    echo "<td><a href='profileWORK.php?ID=$row[0]'>Profile</a></td> ";
