        ...
        <div class="row">
            <div class="col-md-13 mx-auto mt-5"> 
                <div class="card">
                    ...
                    $strSQL = "SELECT * FROM employer WHERE ID = '".$_GET["ID"]."' ";
                    ...
                    <td><input type="text" name="txtProperty" size="50" value="<?php echo $objResult["Property"];?>"></td>
                    ...
                    <td><input type="text" name="txtPrice" size="5" value="<?php echo $objResult["Price"];?>"></td>
                    </tr>
                    </table>
